...
cl /nologo /Zi /EHs /MDd /W4 /Fe: ..\bin\main.exe *.obj /link /SUBSYSTEM:CONSOLE ..\deps\sdl2\lib\x86\SDL2.lib ..\deps\sdl2\lib\x86\SDL2main.lib ..\deps\sdl2\lib\x86\SDL2_image.lib ..\deps\sdl2\lib\x86\SDL2_ttf.lib opengl32.lib shell32.lib user32.lib gdi32.lib